        ...
        try:
            ...
            if form.is_valid():
                if seat_availability.total_seats > seat_availability.booked_seats:
                    ...
                    #return HttpResponseRedirect('/success_booking/', ticket_reservation.PNR_no)
                    return redirect('success_booking', pnr_no=ticket_reservation.PNR_no)
                    ...
                    # Redirect to the search page
                    #return HttpResponseRedirect("/search-train/")
                    #return HttpResponseRedirect('/success_booking/', pnr_no=ticket_reservation.PNR_no)
                    return redirect('success_booking', pnr_no=ticket_reservation.PNR_no)
