...
class TicketReservation(models.Model):
    ...
    from_station = models.ForeignKey(Station, on_delete=models.PROTECT, related_name="from_station_r")
    to_station = models.ForeignKey(Station, on_delete=models.PROTECT, related_name="to_station_r")
